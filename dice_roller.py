import random, sys
print("""
DICE ROLLER:  ROLL YO' DICE LIKE YA' ROLL YO' CIGS!  by A. Swiegart.
...
Examples:
      ...
      "QUIT" quits the programa""")

while True:
    try:
        diceStr = input('> ')
        if diceStr.upper()=='QUIT':
            print("Thanks for rollin' with me, homey.")
            sys.exit()
        ...
        print(diceStr, numberOfDice, numberOfSides, modAmount)
        ...
        print('Input was invalid becuase: '+ str(exc))
        continue